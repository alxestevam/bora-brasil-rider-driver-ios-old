...
//                    DialogBuilder.alertOnError(message: NSLocalizedString("Empty_Wallet_Error", comment: ""))
//                    self.navigationController?.popViewController(animated: true)
//                    return
//                }
//                if methods.gateways.count < 1 {
//                    DialogBuilder.alertOnError(message: NSLocalizedString("No_Payment_Method_On", comment: ""))
//                    self.navigationController?.popViewController(animated: true)
//                    return
//                }
...
//            }
//        }
//        form +++ Section(header: "", footer: self.amount == nil ? "" : NSLocalizedString("Wallet_Footnote", comment: "")) {
//            $0.tag = "sec_currrent_credit"
//            }
//            <<< LabelRow("fee") {
//                $0.title = NSLocalizedString("Service_Fee", comment: "")
//                if self.amount != nil {
...
//                $0.title = NSLocalizedString("Credit", comment: "")
//                $0.selectorTitle = NSLocalizedString("Current_Credit", comment: "")
...
//                }
//            }
//        form +++ Section(NSLocalizedString("Add_Credit", comment: "Wallet section title")) {
...
//                $0.title = NSLocalizedString("Pay", comment: "")
//            }.onCellSelection() {cell, row in
//                guard let amountRowValue = self.amountRow.value else {
//                    DialogBuilder.alertOnError(message: NSLocalizedString("Amount_Missing", comment: "Amount is not entered for payment"))
//                    return
//                }
...
//                        DialogBuilder.alertOnError(message: NSLocalizedString("Card_Info_Missing", comment: "alert for card info not being entered"))
//                        return
//                    }
...
//                LoadingOverlay.shared.hideOverlayView()
//                DialogBuilder.alertOnError(message: NSLocalizedString("User_Canceled", comment: "alert for user canceling payment"))
...
//        STPPaymentConfiguration.shared().publishableKey = self.methodsRow.value!.publicKey!
...
//                DialogBuilder.alertOnSuccess(message: NSLocalizedString("Payment_Successful", comment: "Alert shown after successful payment."))
//                
//            case .failure(let error):
...
//        let question = UIAlertController(title: NSLocalizedString("Verification", comment: "Verification Title"), message: error.status == .OTPCodeRequired ? NSLocalizedString("Alert_Enter_OTP_Code", comment: "OTP Message") : NSLocalizedString("Alert_Enter_PIN_Code", comment: "PIN Code message"), preferredStyle: .alert)
